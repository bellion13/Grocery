            ...
            <div className='max-w-7xl mx-auto flex justify-between items-center h-full px-5 md:px-0'>
                ...
                <div className='flex-1'>
                    ...
                    <div className='mt-8 gap-4 flex'>
                        <button className='bg-white text-green-600 px-6 py-2 rounded-full mr-4 cursor-pointer hover:opacity-90'>Shop Now</button>
                        <button className='bg-green-800 border-2 border-white text-white px-6 py-2 rounded-full cursor-pointer hover:bg-green-600'>Learn More</button>
                    </div>
                </div>
                {/* image hero */}
                <div className='flex-1'>
